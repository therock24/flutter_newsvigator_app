import 'package:flutter_newsvigator_app/di/provider/dio_provider.dart';
import 'package:flutter_newsvigator_app/features/daily_news/domain/usecases/get_all_news.dart';
...
Future<void> initializeDependencies() async {
  ...
  // Dio
  sl.registerSingleton<Dio>(DioProvider.configure(newsAPIBaseURL));
  ...
  //UseCases
  sl.registerSingleton<GetTopArticlesUseCase>(GetTopArticlesUseCase(sl()));

  sl.registerSingleton<GetAllNewsUseCase>(GetAllNewsUseCase(sl()));
